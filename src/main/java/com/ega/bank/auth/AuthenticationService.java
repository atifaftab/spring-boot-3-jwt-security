...
import com.ega.bank.token.TokenRepository;
import com.ega.bank.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    Account account = accountService.creatBankAccount(request.getBalance(), savedUser, request.getAccountType());
